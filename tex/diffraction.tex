...
has a similar block structure as the augmented covariance matrix inx
...
\begin{figure}[tbp]
  ...
  \subfloat[][]{%
    ...
    \includegraphics[width=0.5\textwidth]{diffractive/intensity}%
  }%
  \subfloat[][]{%
    \label{fig:diffraction_study_efficiency}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/acceptance}%
  }%
  \\%
  \subfloat[][]{%
    \label{fig:diffraction_study_intensity_acc}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/intensity}%
  }%
  \subfloat[][]{%
    \label{fig:diffraction_study_data}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/hData}%
  }%
...
using \cref{eq:diffraction_integral_matrix} with \num{e7}~events that
are sampled randomly from the detection efficiency $\eta(\Omega)$ in
...
\begin{figure}[tbp]
  ...
  \subfloat[][]{%
    ...
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/hCompareRe}%
  }%
  \subfloat[][]{%
    \label{fig:diffraction_study_comparison_im}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/hCompareIm}%
  }%
  \\%
  \subfloat[][]{%
    \label{fig:diffraction_study_residual_re}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/hResidualsRe}%
  }%
  \subfloat[][]{%
    \label{fig:diffraction_study_residual_im}%
    \includegraphics[width=0.5\textwidth]{diffractive/acc_1/hResidualsIm}%
  }%
