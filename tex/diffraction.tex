...
\begin{equation}
  ...
  = P_1\, P_2\, (-1)^\ell.
\end{equation}
Assuming that $X$~decays into two daughter particles of equal parity,
\eg two pseudoscalars such as $\etaOrPr \pi$,
...
\cref{eq:diffraction_moments_pw} and the symmetry
