...
\begin{align}
  ...
  H_{1, 2}(L, M)
  ={}& \frac{1}{P_\gamma}\, \frac{1}{\pi}\, \sqrt{\frac{4 \pi}{2 L + 1}} \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
...
intensity distribution is independent of~$\Phi$.\todo{Make statement
stronger: $H_0$ behaves identical to diffractive case.}  The two
...
matrix of~$X$.  We see this by inserting \cref{eq:spherical_harm_prod}
into \cref{eq:photoprod_intensity_components} and comparing with
...
\begin{align}
  ...
  \\
  H_{1, 2}^*(L, M)
  ={}& (-1)^M\, \frac{1}{P_\gamma}\, \frac{1}{\pi}\, \sqrt{\frac{4 \pi}{2 L + 1}} \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \mathcal{I}(\Omega, \Phi)\, Y_L^{(-M) *}(\Omega) \times \begin{cases*}
    \cos(2 \Phi) & for $i = 1$, \\
    \sin(2 \Phi) & for $i = 2$
  \end{cases*}
...
\crefrange{eq:photoprod_rho_0}{eq:photoprod_rho_2}, which are
...
Eq.~(B6) in \refCite{Mathieu:2019fts}.}
\begin{align}
  ...
  H_2(L, M)
  ={}& -\imag \frac{1}{P_\gamma}\, \frac{1}{\pi}\, \sqrt{\frac{4 \pi}{2 L + 1}} \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
...
Analogous to \cref{eq:diffraction_intensity_moments_real}, we can
rewrite
...
advantage that in the high-energy limit at leading order, \refl~corresponds to the naturality of the spin-parity exchanged in the
...
In order to calculate the photoproduction moments from data, we will
...
To relate the measured moments to the physical moments, we insert
...
\begin{align}
  ...
  H_0(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\,
  ...
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  P_\gamma\, y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\, \cos(2 \Phi)\,
  Y_L^{M *}(\Omega)}{\equiv I^\text{acc}_{0 1\, L M\, L' M'}} \notag
  \\
  & + H_2(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.4em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  \imag\, P_\gamma\, y_{L'}^{M'}(\theta)\, \sin(M'\, \phi)\, \sin(2 \Phi)\,
  Y_L^{M *}(\Omega)}{\equiv I^\text{acc}_{0 2\, L M\, L' M'}}\, \Bigg] \notag
  \\
  \label{eq:photoprod_moment_0_meas2}
  ={}& \sum_{j = 0}^2 \sum_{L' = 0}^\infty \sum_{M' = 0}^{L'}
  I^\text{acc}_{0 j\, L M\, L' M'}\, H_i(L', M').
\end{align}
Similarly,
\begin{align}
  H_1^\text{meas}(L, M)
  ...
  \eta(\Omega, \Phi)\,
  y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \cos(2 \Phi)}{\equiv I^\text{acc}_{1 0\, L M\, L' M'}} \notag
  \\
  & + H_1(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  P_\gamma\, y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\, \cos(2 \Phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \cos(2 \Phi)}{\equiv I^\text{acc}_{1 1\, L M\, L' M'}} \notag
  \\
  & + H_2(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  \imag\, P_\gamma\, y_{L'}^{M'}(\theta)\, \sin(M'\, \phi)\, \sin(2 \Phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \cos(2 \Phi)}{\equiv I^\text{acc}_{1 2\, L M\, L' M'}}\, \Bigg] \notag
  \\
  \label{eq:photoprod_moment_1_meas2}
  &= \sum_{j = 0}^2 \sum_{L' = 0}^\infty \sum_{M' = 0}^{L'}
  I^\text{acc}_{1 j\, L M\, L' M'}\, H_i(L', M')
\end{align}
and
\begin{align}
  H_2^\text{meas}(L, M)
  ...
  \eta(\Omega, \Phi)\,
  y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \sin(2 \Phi)}{\equiv I^\text{acc}_{2 0\, L M\, L' M'}} \notag
  \\
  & + H_1(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  P_\gamma\, y_{L'}^{M'}(\theta)\, \cos(M'\, \phi)\, \cos(2 \Phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \sin(2 \Phi)}{\equiv I^\text{acc}_{2 1\, L M\, L' M'}} \notag
  \\
  & + H_2(L', M')\,
  \rdUnderbrace{\frac{1}{2 \pi}\, \sqrt{\frac{2 L' + 1}{2 L + 1}}\, (2 - \delta_{M' 0})
  \int_{4 \pi}\!\!\!\! \dif{\Omega} \int_{-\pi}^{+\pi}\hspace{-1.2em} \dif{\Phi}\,
  \eta(\Omega, \Phi)\,
  \imag\, P_\gamma\, y_{L'}^{M'}(\theta)\, \sin(M'\, \phi)\, \sin(2 \Phi)\,
  \frac{2}{P_\gamma}\, Y_L^{M *}(\Omega)\, \sin(2 \Phi)}{\equiv I^\text{acc}_{2 2\, L M\, L' M'}}\, \Bigg] \notag
  \\
  \label{eq:photoprod_moment_2_meas2}
  &= \sum_{j = 0}^2 \sum_{L' = 0}^\infty \sum_{M' = 0}^{L'}
  I^\text{acc}_{2 j\, L M\, L' M'}\, H_i(L', M').
\end{align}

\Crefrange{eq:photoprod_moment_0_meas2}{eq:photoprod_moment_2_meas2}
are equivalent to \cref{eq:diffraction_moments_meas2}.  As expected,
the detection efficiency $\eta(\Omega, \Phi)$ mixes the contributions
from the physical moments.  However, the relation between measured and
physical moments is still given by a linear equation, \ie
\begin{equation}
  \label{eq:photoprod_moments_meas_matrix}
  \vect{H}_\text{meas}
  = \mat{I}^\text{acc}\, \vect{H},
\end{equation}
which is identical to \cref{eq:diffraction_moments_meas_matrix}.  In the