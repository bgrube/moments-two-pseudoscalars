...
$\mat{I}^\text{acc}$ becomes a unit matrix.\todo{Can one show that
$\mat{I}^\text{acc}$ must be real-valued?}
...
\begin{equation}
  ...
  \eta(\Omega, \Phi)
  = \rBrk[3]{\frac{3}{2} - \cos^2 \theta} \rBrk[3]{\frac{3}{2} - \frac{\phi^2}{\pi^2}} \rBrk[3]{\frac{3}{2} - \frac{\Phi^2}{\pi^2}},
\end{equation}
